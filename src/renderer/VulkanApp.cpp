...
void VulkanApp::createInstance() {
    ...
    appInfo.pApplicationName = "Solar System Engine MVP";
    appInfo.applicationVersion = VK_MAKE_VERSION(0, 1, 0);
    appInfo.pEngineName = "SolarEngine";
...
bool VulkanApp::isDeviceSuitable(VkPhysicalDevice deviceCandidate) const {
    auto queueFamilyIndices = findQueueFamilies(deviceCandidate);
    ...
    if (extensionsSupported) {
        auto swapChainSupport = querySwapChainSupport(deviceCandidate);
...
VulkanApp::QueueFamilyIndices VulkanApp::findQueueFamilies(VkPhysicalDevice deviceCandidate) const {
...
VulkanApp::SwapChainSupportDetails VulkanApp::querySwapChainSupport(VkPhysicalDevice deviceCandidate) const {
...
VkPresentModeKHR VulkanApp::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) const {
...
VkResult VulkanApp::CreateDebugUtilsMessengerEXT(
    VkInstance instanceValue,
    const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo,
    const VkAllocationCallbacks* pAllocator,
    VkDebugUtilsMessengerEXT* pDebugMessenger
) {
    auto func = reinterpret_cast<PFN_vkCreateDebugUtilsMessengerEXT>(
        vkGetInstanceProcAddr(instanceValue, "vkCreateDebugUtilsMessengerEXT")
    );
    if (func != nullptr) {
        return func(instanceValue, pCreateInfo, pAllocator, pDebugMessenger);
    }
...
void VulkanApp::DestroyDebugUtilsMessengerEXT(
    ...
    auto func = reinterpret_cast<PFN_vkDestroyDebugUtilsMessengerEXT>(
        vkGetInstanceProcAddr(instanceValue, "vkDestroyDebugUtilsMessengerEXT")
    );
    if (func != nullptr) {
        func(instanceValue, messenger, pAllocator);
    }
}
